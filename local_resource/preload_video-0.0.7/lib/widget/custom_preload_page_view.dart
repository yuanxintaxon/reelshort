...
class PageScrollPhysics extends ScrollPhysics {
  ...
  const PageScrollPhysics({ScrollPhysics? parent,required this.scrollSpeed}) : super(parent: parent);

  @override
  PageScrollPhysics applyTo(ScrollPhysics? ancestor) {
    return PageScrollPhysics(parent: buildParent(ancestor),scrollSpeed: scrollSpeed);
  }
...
class _PreloadPageViewState extends State<PreloadPageView> {
  ...
  Widget build(BuildContext context) {
    ...
    final ScrollPhysics? physics = widget.pageSnapping
        ? PageScrollPhysics(scrollSpeed: widget.scrollSpeed).applyTo(widget.physics)
        : widget.physics;
    return Listener(
      ...
      child: NotificationListener<ScrollNotification>(
        onNotification: (ScrollNotification notification) {
          ...
          if (notification is ScrollStartNotification) {
            //print('滑动开始:${widget.controller.position.pixels}');
          }
          ...
          if (notification.depth == 0 &&
            ...
            ///手未抬起的情况下记录滑动系数
            if(!panHasUp){
              isOut = widget.controller.position.pixels >
          ...
          if (notification.depth == 0 &&
            ...
            if (isOut) {
              ...
              //print('滑动结束:${widget.controller.position.pixels}');
            }
          }
